...
import vkQr from "@/assets/vk-qr-reference-final.png.asset.json";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Таро Рофлан Судьбы — купить колоду Рофлан таро, 78 карт, 3333 ₽" },
      {
        name: "description",
        content:
          "Таро Рофлан (Таророфлан) — авторская колода «Рофлан Судьбы» из 78 арканов: значения карт таро, толкование, расклад на отношения и таро дня онлайн. Подарочная коробка и инструкция. 3333 ₽ с доставкой.",
      },
      {
        name: "keywords",
        content:
          "рофлан, таро рофлан, таророфлан, рофлан судьбы, колода рофлан, таро рофлан судьбы купить, колода таро, таро купить, карты таро купить, колода карт таро, значение карт таро, толкование таро, перевёрнутые карты таро, расклад таро на отношения, таро дня, таро на неделю",
      },
      { property: "og:title", content: "Таро Рофлан Судьбы — купить колоду Рофлан таро, 78 карт" },
      {
        property: "og:description",
        content:
          "Таро Рофлан (Таророфлан): авторская колода «Рофлан Судьбы» — 78 арканов, значения и толкования в инструкции, таро дня онлайн. 3333 ₽ с доставкой.",
      },
      { property: "og:site_name", content: "Таро Рофлан Судьбы" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: ["Таро Рофлан", "Таророфлан", "Рофлан Судьбы", "Колода Рофлан"],
          description:
            "Таро Рофлан (Таророфлан) — авторская колода «Рофлан Судьбы» из 78 карт с ручными иллюстрациями и мемными подписями. Плотный картон, подарочная коробка и инструкция в комплекте.",
          brand: {
            "@type": "Brand",
            name: "Рофлан Судьбы",
            alternateName: ["Таро Рофлан", "Таророфлан", "Рофлан"],
          },
          category: "Карты Таро",
...
const FAQS = [
  {
    question: "Таро Рофлан, Таророфлан и «Рофлан Судьбы» — это одно и то же?",
    answer:
      "Да. Таро Рофлан (его же пишут как Таророфлан или просто Рофлан) — это наша авторская колода «Рофлан Судьбы». Официальный сайт колоды — taroroflan.ru, здесь же можно купить колоду Рофлан и вытянуть карту в разделе «Таро дня».",
  },
  {
